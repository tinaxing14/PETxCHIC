      ...
      <div className='productdetail_container'>
        ...
        <div className='product_info'>
          ...
          <div calssName='btn__container'>
            <div><button className="productdetail__btn" onClick={() => {addToCart(product.id, size, product.price, product.images[0], product.name)}}>Add to Cart</button>
          </div>
          <div className='spinner__container'>
            {spinner ? <div className="success__spinner"></div>: null}{sucess}</div>
          </div>
        </div>
    </div>
  </div>
